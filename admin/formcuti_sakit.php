...
?>
  ...
  <?php
      ...
      $i=$_POST['no_tlp'];
       ...
       $tambah=mysqli_query($con, "INSERT INTO cuti_sakit (jenis_cuti,tgl_pengajuan,NIP_pengaju,alasan_cuti,lama_cuti,tgl_mulai,tgl_selesai,alamat,provinsi,no_tlp) VALUES ('$x','$b','$c','$d','$e','$f','$g','$hi','$h','$i')");
    ...
    <div class="container-fluid">
      ...
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> Buat Pengajuan Cuti Sakit</div>
        <div class="card-body">
          </div>
 
<table>
<td style="width:70px;"></td>
<h3>&nbsp;&nbsp;&nbsp;Buat Pengajuan Cuti Sakit Pegawai</h3><br>
