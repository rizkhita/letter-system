      ...
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Components">
          <a class="nav-link nav-link-collapse collapsed" data-toggle="collapse" href="#collapseComponents3" data-parent="#exampleAccordion">
            ...
            <span class="nav-link-text">Akun Cuti Online <i class="fa fa-check"></i></span>
          </a>
          <ul class="sidenav-second-level collapse" id="collapseComponents3">
            <li>
              <a href="akun_pns.php">Akun Pegawai <i class="fa fa-check"></i></a>
            </li>
            <li>
              <a href="akun_ppk.php">Akun PPK <i class="fa fa-check"></i></a>
            </li>
            <li>
              <a href="akun_kadin.php">Akun Kepala Dinas <i class="fa fa-check"></i></a>
            </li>
            <li>
              <a href="akun_admin.php">Akun Administrator <i class="fa fa-check"></i></a>
            </li>
          </ul>
        </li>
        </li>
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Components">
          <a class="nav-link nav-link-collapse collapsed" data-toggle="collapse" href="#collapseComponents4" data-parent="#exampleAccordion">
            ...
            <span class="nav-link-text">Bagian dan Sekertariat<i class="fa fa-check"></i></span>
          </a>
          <ul class="sidenav-second-level collapse" id="collapseComponents4">
            <li>
              <a href="bagian.php">Daftar Bidang dan Sekertariat<i class="fa fa-check"></i></a>
            </li>
            <li>
              <a href="data_ppk.php">Data Kepala Bidang<i class="fa fa-check"></i></a>
            </li>
            <li>
              <a href="data_anggota.php">Data Anggota Bidang<i class="fa fa-check"></i></a>
            </li>
