...
?>
  ...
  <?php
      ...
      $i=$_POST['no_tlp'];
       ...
       $tambah=mysqli_query($con, "INSERT INTO cuti_kap (jenis_cuti,tgl_pengajuan,NIP_pengaju,alasan_cuti,lama_cuti,tgl_mulai,tgl_selesai,alamat,provinsi,no_tlp) VALUES ('$x','$b','$c','$d','$e','$f','$g','$hi','$h','$i')");
    ...
    <div class="container-fluid">
      ...
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> Pengajuan Cuti Karena Alasan Penting</div>
        <div class="card-body">
          </div>
 
<table>
<td style="width:70px;"></td>
<h3>&nbsp;&nbsp;&nbsp;Buat Pengajuan CKAP Pegawai</h3><br>
<form action="formcuti_kap.php"  method="post">
<td>
  <input type="hidden" name="jenis_cuti" value="Karena Alasan Penting" class="form-control" style="width:300px;">
  <!-- <input type="hidden" name="id_pengajuan" class="form-control" style="width:300px;"> -->
   <div class="form-group">
    ...
    <div class="form-group">
      ...
      <input type="number" name="lama_cuti" class="form-control" style="width:300px;height;">
    </div>
    <div class="form-group">
