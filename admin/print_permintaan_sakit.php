...
$query =mysqli_query( $con,"SELECT NIP_pengaju,jenis_cuti,lama_cuti,tgl_mulai,tgl_selesai,alamat,provinsi,no_tlp,sp_kabid,sp_alasan FROM cuti_sakit  WHERE  id_pengajuan='$id_pengajuan'  ");
...
//LAMA CUTI
echo "<div style='margin-left:20px;'><h4><b>III. LAMA CUTI</b></h4></div>";
...
echo "<div style='margin-left:20px;'><h4><b>IV. ALAMAT SELAMA MENJALANKAN CUTI</b></h4></div>";
...
//KEPUTUSAN PEJABAT
echo "<div style='margin-left:20px;'><h4><b>V. KEPUTUSAN PEJABAT YANG MEMBERIKAN CUTI </b></h4></div>";
echo "<table style='width:700%;margin-left:40px;margin-right:20px;'>";
echo "<tr>";
...
$pdf->WriteHTML($html);
$pdf->Output('Pengajuan Cuti Sakit.pdf', 'D');
?>