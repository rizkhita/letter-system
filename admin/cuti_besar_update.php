...
?>
  ...
  <?php
      ...
      $edited=mysqli_query($con, "UPDATE cuti_besar set jenis_cuti='$x',tgl_pengajuan='$b',NIP_pengaju='$c',alasan_cuti='$d',lama_cuti='$e',tgl_mulai='$f',tgl_selesai='$g',alamat='$h0',provinsi='$h',no_tlp='$i',sp_dinas='$j',sp_alasan1='$k',sp_bkd='$l',sp_alasan2='$m' where id_pengajuan='$id'");
...
<h3>&nbsp;&nbsp;&nbsp;Edit Pengajuan Cuti Besar Pegawai</h3><br>
<form action="cuti_besar_update.php?id_pengajuan=<?php echo $id;?>" name="updatedata" method="post">
<td>
