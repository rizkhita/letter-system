...
?>
  ...
  <?php
      ...
      $edited=mysqli_query($con, "UPDATE cuti_sakit set jenis_cuti='$x',tgl_pengajuan='$b',NIP_pengaju='$c',alasan_cuti='$d',lama_cuti='$e',tgl_mulai='$f',tgl_selesai='$g',alamat='$h0',provinsi='$h',no_tlp='$i',sp_kabid='$j',sp_alasan='$k' where id_pengajuan='$id'");
