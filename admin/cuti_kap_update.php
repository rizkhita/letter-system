...
?>
  ...
  <?php
      ...
      $edited=mysqli_query($con, "UPDATE cuti_kap set jenis_cuti='$x',tgl_pengajuan='$b',NIP_pengaju='$c',alasan_cuti='$d',lama_cuti='$e',tgl_mulai='$f',tgl_selesai='$g',alamat='$h0',provinsi='$h',no_tlp='$i',sp_kabid='$j',sp_alasan='$k' where id_pengajuan='$id'");
...
<!-- end -->
 ...
 <?php
          ...
          $sql = mysqli_query($con, "SELECT * FROM cuti_kap WHERE id_pengajuan = '$id'");
...
<h3>&nbsp;&nbsp;&nbsp;Edit Pengajuan CKAP Pegawai</h3><br>
<form action="cuti_kap_update.php?id_pengajuan=<?php echo $id;?>" name="updatedata" method="post">
<td>
