...
?>
  ...
  <?php
      ...
      $i=$_POST['no_tlp'];
       ...
       $tambah=mysqli_query($con, "INSERT INTO cuti_besar (jenis_cuti,tgl_pengajuan,NIP_pengaju,alasan_cuti,lama_cuti,tgl_mulai,tgl_selesai,alamat,provinsi,no_tlp) VALUES ('$x','$b','$c','$d','$e','$f','$g','$hi','$h','$i')");
...
<h3>&nbsp;&nbsp;&nbsp;Buat Pengajuan Cuti Besar Pegawai</h3><br>
<form action="formcuti_besar.php"  method="post">
<td>
  <input type="hidden" name="jenis_cuti" value="Besar" class="form-control" style="width:300px;">
  <!-- <input type="hidden" name="id_pengajuan" class="form-control" style="width:300px;"> -->
   <div class="form-group">
    ...
    <div class="form-group"> 
      ...
      <input type="hidden" value="3" name="lama_cuti" class="form-control" style="width:300px;height;">
     </div>
    <div class="form-group">
