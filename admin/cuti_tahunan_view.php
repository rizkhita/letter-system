...
<?php
    ...
    $query2=mysqli_query($con,"SELECT cuti_tahunan.NIP_pengaju,data_pns.nama,cuti_tahunan.tgl_pengajuan,cuti_tahunan.lama_cuti,cuti_tahunan.tgl_mulai,cuti_tahunan.tgl_selesai,cuti_tahunan.sp_kabid,cuti_tahunan.sp_alasan from cuti_tahunan inner join data_pns on cuti_tahunan.NIP_pengaju=data_pns.NIP  where cuti_tahunan.id_pengajuan='$id'");
