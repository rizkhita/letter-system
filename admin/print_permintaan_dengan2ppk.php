...
$query =mysqli_query( $con,"SELECT NIP_pengaju,jenis_cuti,alasan_cuti,lama_cuti,tgl_mulai,tgl_selesai,alamat,provinsi,no_tlp,sp_kabid,sp_alasan FROM cuti_kap  WHERE  id_pengajuan='$id_pengajuan'  ");
