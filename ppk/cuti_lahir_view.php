...
?>
  ...
  <?php
      ...
      $edited=mysqli_query($con, "UPDATE cuti_lahir set sp_dinas='$j',sp_alasan1='$k' where id_pengajuan='$id'");
...
<h3>&nbsp;&nbsp;&nbsp;Pengajuan Cuti Melahirkan Pegawai</h3><br>
<form action="cuti_lahir_view.php?id_pengajuan=<?php echo $id;?>" name="updatedata" method="post">
<td>
  <input type="hidden" name="id_pengajuan" value="<?php echo $data['id_pengajuan'];?>" class="form-control" style="width:300px;"> 
   <div class="form-group">
    ...
    <div class="form-group">
     <label >Provinsi: <?php echo $data['provinsi']; ?></label>
      </div>
    <div class="form-group">
