...
<?php
    ...
    $query=mysqli_query($con,"SELECT anggota_bidang.NIP,anggota_bidang.kode_bidang,cuti_kap.id_pengajuan,data_pns.nama,cuti_kap.NIP_pengaju,cuti_kap.tgl_pengajuan,cuti_kap.alasan_cuti,cuti_kap.lama_cuti,cuti_kap.tgl_mulai,cuti_kap.tgl_selesai,cuti_kap.provinsi,cuti_kap.no_tlp,cuti_kap.sp_kabid,cuti_kap.sp_alasan FROM cuti_kap inner join data_pns on cuti_kap.NIP_pengaju=data_pns.NIP inner join anggota_bidang on cuti_kap.NIP_pengaju=anggota_bidang.NIP where cuti_kap.id_pengajuan='$id'");
