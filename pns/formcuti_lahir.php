...
?>
  ...
  <?php
      ...
      $i=$_POST['no_tlp'];
       ...
       $tambah=mysqli_query($con, "INSERT INTO cuti_lahir (jenis_cuti,tgl_pengajuan,NIP_pengaju,alasan_cuti,lama_cuti,tgl_mulai,tgl_selesai,alamat,provinsi,no_tlp) VALUES ('$x','$b','$c','$d','$e','$f','$g','$hi','$h','$i')");
...
<h3>&nbsp;&nbsp;&nbsp;Buat Pengajuan Cuti Melahirkan</h3><br>
<form action="formcuti_lahir.php"  method="post">
<td>
  <input type="hidden" name="jenis_cuti" value="Melahirkan" class="form-control" style="width:300px;">
