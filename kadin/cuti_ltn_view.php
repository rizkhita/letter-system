...
?>
  ...
  <?php
      ...
      $edited=mysqli_query($con, "UPDATE cuti_ltn set sp_dinas='$j',sp_alasan1='$k' where id_pengajuan='$id'");
...
<form action="cuti_ltn_view.php?id_pengajuan=<?php echo $id;?>" name="updatedata" method="post">
<td>
